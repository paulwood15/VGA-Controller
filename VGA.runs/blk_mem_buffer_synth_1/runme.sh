...
HD_PWD='C:/Users/Paul/Documents/VGA/VGA.runs/blk_mem_buffer_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blk_mem_buffer.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blk_mem_buffer.tcl
